...
function Productslarge() {
    ...
    const [product, setProduct] = useState([])
        ...
        //   const slideRight = () => {
        //     setPosition(prevPosition => Math.min(prevPosition + 1, 4)); 
        //   };
                ...
                <div className='products-header-flex'>
                    ...
                    <div className='product-buttons-flex'>
                        <div className='accordan-arrow'>
                            <button><svg xmlns="http://www.w3.org/2000/svg"  width="25" height="25px" viewBox="0 0 64 64" id="arrow"><path fill="#134563" d="M37.9 46 24.1 32.3l13.8-13.7 2 2-11.8 11.7L39.9 44l-2 2"></path></svg></button>
                        </div>
                        <div className='accordan-arrow'>
                            <button ><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" enable-background="new 0 0 64 64" viewBox="0 0 64 64" id="arrow"><path fill="#134563" d="m-210.9-289-2-2 11.8-11.7-11.8-11.7 2-2 13.8 13.7-13.8 13.7" transform="translate(237 335)"></path></svg></button>
                        </div>
                    </div>
                </div>
                                ...
                                product.map((obj)=>{
                                    return(
                                        ...
                                        <div className='product-price'>
                                            <p>${obj.price}</p> <p style={{opacity:"60%"}}><s>$10,000</s></p>
                                        </div>
                                    </div>
                                    )
                                }) 
